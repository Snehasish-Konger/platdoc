...
export const FONTS = {
    ...
    body1: { fontFamily: "AdventPro-Regular", fontSize: SIZES.body1, lineHeight: 36 },
    body2: { fontFamily: "AdventPro-Regular", fontSize: SIZES.body2, lineHeight: 30 },
    body3: { fontFamily: "AdventPro-Regular", fontSize: SIZES.body3, lineHeight: 22 },
    body4: { fontFamily: "AdventPro-Regular", fontSize: SIZES.body4, lineHeight: 22 },
};
